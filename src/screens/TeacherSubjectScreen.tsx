...
const OPTIONS: SubjectOption[] = [
  { id: 'languages', title: 'Языки', description: 'Иностранные и родной язык', icon: 'language' },
  { id: 'math', title: 'Математика', description: 'Алгебра, геометрия, статистика', icon: 'calculator' },
  { id: 'sciences', title: 'Естественные науки', description: 'Физика, химия, биология', icon: 'flask' },
  { id: 'humanities', title: 'Гуманитарные', description: 'История, литература, право', icon: 'book' },
  { id: 'corporate', title: 'Корпоративное', description: 'Бизнес-обучение и тренинги', icon: 'briefcase' },
  { id: 'other', title: 'Другое', description: 'Музыка, спорт, другие предметы', icon: 'ellipsis-horizontal' },
];
...
export function TeacherSubjectScreen({ onContinue, onBack }: Props) {
  ...
  const renderOption = (option: SubjectOption) => {
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.headlineBlock}>
            ...
            <Text variant="body" color="secondary" style={styles.bodyText}>
              Мы подберём шаблоны и инструменты для вашего предмета.
            </Text>
          </View>
